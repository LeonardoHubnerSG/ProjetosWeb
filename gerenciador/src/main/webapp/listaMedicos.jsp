	...
	<table style='margin:1px'>
		...
		<c:forEach items="${medicos}" var="medico">
			<tr>
				...
				<td>${medico.crm }</td>
				<td style='text-align:center'><a href='/gerenciador/mostraMedico?id=${medico.id }'>Editar</a></td>
				<td style='text-align:center'><a href='/gerenciador/removeMedico?id=${medico.id }'>Remover</a></td>
			</tr>
		</c:forEach>
	</table>
	<br/>
